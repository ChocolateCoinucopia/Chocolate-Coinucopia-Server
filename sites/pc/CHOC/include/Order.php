...
<article id="Order-Chocolate-Coins" class="f20">
    <form>
        <div id="Order-Ticket" style="display: none;">
            <div class="left pis-280 numeric">
                <div class="m-b10">
                    <span>
                        <label class="f20">Order:&nbsp;</label>
                        ...
                        &nbsp;
                        <label id="Order-Predicate" class="f20">with</label>
                        &nbsp;
                ...
                <div class="m-b10">
                    <span>
                        <label class="f20">Quantity:&nbsp;</label>
                ...
                <div class="m-b10">
                    <span>
                        <label class="f20">Exchange&nbsp;Price:&nbsp;</label>
                    </span>
                    <span>
                    ...
                    <span>
                        <label id="Order-Quote-Base" class="f20">&nbsp;ETH&nbsp;per&nbsp;CC</label>
                    </span>
                </div>
            </div>
            <div class="m-b10">
        ...
        <div id="Order-Confirm" style="display: none;">
            <div>
                <p class="Order-Confirmation numeric f25"></p>
            </div>
            <div class="m-b10">
                <span>
