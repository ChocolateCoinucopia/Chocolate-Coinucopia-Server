...
<html lang="en">
  ...
  <body class="WC1">
html;
    require_once '/var/www/sites/mobile/CHOC/include/ChartPanel.php';
echo <<< html
    <div id="Chart-Graph">
...
html;
    require_once '/var/www/sites/mobile/CHOC/include/ChartPalette.php';
echo <<< html
    ...
    <script src="/js/ChartPalette.js"></script>
